<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ESC_Login.aspx.cs" Inherits="ESC_Web.Alan.ESC_Login" %>
...
<head runat="server">
    ...
    <title>e-StartUp Check List 登入系統</title>
    <style type="text/css">
    .pie{                
...
<body>
    ...
    <table>
        <tr>
            <%--<td colspan="2" style="background-image:url('images/bg_logo.gif') ;
                background-position:left;
                background-repeat:no-repeat;
                height:70px;">
            </td>--%>
            <td style="height:70px;">
                <asp:Image ID="Image1" runat="server" ImageUrl="images/bg_logo.gif" />
            </td>
            <td>
                <asp:Image id="image2" runat="server" ImageUrl="images/banner_startup1.png"/>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="padding:0 0 0 20px;">
                <div class="pie">
                    ...
                    預設密碼請輸入<div style="color:Red; display:inline;">身分證號碼後四碼</div>。<br />
                    e.g. 1234 (4 digits)<br />
                    <br />
                    Owner：H.F.Wu #8030<br />
                    IT Support : Alan Kuo #8236
                    <br />
                    <div style="color:red; display:inline;">Download：</div><asp:HyperLink ID="HyperLink1" NavigateUrl="http://165.114.64.97/eStartupCheck_prod/download/e-Startup%20Check%20List%20User%20Manual.pptx" runat="server">User Manual</asp:HyperLink>
                </div>
            </td>
        </tr>
    </table>
