<%@ Page Title="" Language="C#" MasterPageFile="../Master/MasterPage.master" AutoEventWireup="true" CodeFile="ACS_Manage.aspx.cs" Inherits="ESC_Web.Alan.ACS_Manage" %>
...
<asp:UpdatePanel id="up" runat="server">
    ...
    <asp:GridView ID="GridViewAM" runat="server" DataKeyNames="ACS_ManageID" AutoGenerateColumns="False"
            ...
            OnPageIndexChanging="GridViewAM_PageIndexChanging" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" OnRowCommand="GridViewAM_RowCommand" Width="50%">
            <Columns>                
                ...
                <asp:TemplateField HeaderText="Sheet" SortExpression="Location">
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label3" Text='<%# bind("sc_desc") %>' runat="server"></asp:Label>
                    </ItemTemplate>
                    <HeaderStyle Width="30%" />
                </asp:TemplateField>
