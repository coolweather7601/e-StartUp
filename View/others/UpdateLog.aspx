<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateLog.aspx.cs" Inherits="ESC_Web.Alan.UpdateLog" %>
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" BorderWidth="1px" BorderStyle="Solid"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Item_Desc" HeaderText="Describe" ></asp:BoundField>
