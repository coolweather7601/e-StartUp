<%@ Page Language="C#" MasterPageFile="../Master/MasterPage.master" AutoEventWireup="true" CodeFile="Meco3.aspx.cs" Inherits="ESC_Web.Alan.Meco3" Title="MECO3" %>
...
<asp:UpdatePanel id="up" runat="server">
   <ContentTemplate>  
    <h1>MECO#3  亮錫電鍍檢查表<br /> Bright Tin Plating Check List  </h1>
    <table id='autoTable' >
        <tr>
    ...
    <table class="content_table" style="width:80%;">
            ...
            <tr>                
                ...
                <td class="tdbgt">Clean Filter Mesh 清洗過濾網<br /> 2-2//6, 2-7, 2-8, 11-1/2/3/5/6</td>
                <td class="tdCon">
                    清潔 Clean<br />
            ...
            <tr>
                <td class="tdbgt">換水 6-6, 6-7, 6-8,11-4/7<br /> &nbsp;Water Renew </td>
                <td class="tdCon">
                    換新 Renew<br />
            ...
            <tr>
                <td class="tdbgt">添檢查各風刀無堵塞<br /> Check Blockage In Air Knife</td>
                <td class="tdCon">
                    正常 Normal<br />
