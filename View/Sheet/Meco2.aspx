<%@ Page Language="C#" MasterPageFile="../Master/MasterPage.master" AutoEventWireup="true" CodeFile="Meco2.aspx.cs" Inherits="ESC_Web.Alan.Meco2" Title="MECO2" %>
...
<asp:UpdatePanel id="up" runat="server">
   <ContentTemplate>  
    <h1>MECO#2  霧錫電鍍檢查表<br /> Matte Tin Plating Check List </h1>
    <table id='autoTable' >
        <tr>
    ...
    <table class="content_table" style="width:80%;">
            ...
            <tr>
                ...
                <td rowspan="2" class="tdbgt" style="width:30%;">高壓噴水壓力  <br /> High Pressure Rinse <br />
                    20~50 bar </td>
            ...
            <tr>
                ...
                <td class="tdbgt">LCT-208S (Cu) (4槽)<br />1.030 ~ 1.060(g/cm3)</td>
            ...
            <tr>                
                ...
                <td class="tdCon">
                    空跑 Empty Run <br />
                    <asp:RadioButton ID="rdoEmptyRun_Y" runat="server" Text="V 是" GroupName="J"  CssClass="radio inline"/>&nbsp;&nbsp;
                    <asp:RadioButton ID="rdoEmptyRun_N" runat="server" Text="X 否" GroupName="J" CssClass="radio inline" />
                </td>
            </tr>  
            <tr>                
            ...
            <tr>                
                ...
                <td class="tdbgt">HSOP 反向偵測 <br />reverse loading</td>
                <td class="tdCon">
                    無阻塞 No blockage<br />
                    <asp:RadioButton ID="rdoHsop_Y" runat="server" Text="V 是" GroupName="M_1"  CssClass="radio inline"/>&nbsp;&nbsp;
                    <asp:RadioButton ID="rdoHsop_N" runat="server" Text="X 否" GroupName="M_1" CssClass="radio inline" />
                </td>
            </tr>
            <tr>   
            ...
            <tr>    
                ...
                <td class="tdCon">
                    連結 Connect <br /> 
                    <asp:RadioButton ID="rdoEsdConnect_Y" runat="server" Text="V 是" GroupName="T"  CssClass="radio inline"/>&nbsp;&nbsp;
                    <asp:RadioButton ID="rdoEsdConnect_N" runat="server" Text="X 否" GroupName="T"  CssClass="radio inline"/>
                </td>
            </tr>
            <tr>
